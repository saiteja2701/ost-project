...
$pad=$_POST['aadhar'];
   ...
   $bgp=$_POST['blood'];
   $phone=$_POST['num'];
   echo $sql=" UPDATE patientdetails set paadhar='$pad',password='$pswd', name='$nam',age='$ag',gender='$gen',height='$ht',weight='$wt',dob='$dt',bloodgp='$bgp',phonenum='$phone' where paadhar='".$_SESSION['paid']."'";
